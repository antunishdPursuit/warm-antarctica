...
export default function Home() {
  ...
  return <main className="map-product"><section className="map-experience" aria-label="Interactive Antarctica map"><InteractiveMap active={active} region={region} onSelect={selectStop} />
    ...
    <div className="map-actions"><button onClick={toggleJourney} aria-pressed={playing}>{playing ? "Pause" : journeyElapsed > 0 && journeyElapsed < stops.length * STAGE_DURATION ? "Resume journey" : journeyElapsed > 0 ? "Restart journey" : "Play journey"}</button><button onClick={() => selectStop("water")}>Reset view</button></div>
