...
export default function Home() {
  ...
  return <main className="map-product"><section className="map-experience" aria-label="Interactive Antarctica map"><InteractiveMap active={active} onSelect={selectStop} />
    ...
    <div className="map-actions"><button onClick={toggleJourney} aria-pressed={playing}>{playing ? "Pause" : journeyElapsed > 0 ? "Resume journey" : "Play journey"}</button><button onClick={() => selectStop("water")}>Reset view</button></div>
